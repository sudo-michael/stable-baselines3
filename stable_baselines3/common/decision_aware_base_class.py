...
from stable_baselines3.common.decision_aware_policies import DecisionAwareBasePolicy
from stable_baselines3.common.noise import ActionNoise
from stable_baselines3.common.preprocessing import check_for_nested_spaces, is_image_space, is_image_space_channels_first
from stable_baselines3.common.save_util import load_from_zip_file, recursive_getattr, recursive_setattr, save_to_zip_file
from stable_baselines3.common.type_aliases import GymEnv, MaybeCallback, Schedule, TensorDict
from stable_baselines3.common.utils import (
    FloatSchedule, # get_schedule_fn is depreated
...
SelfBaseAlgorithm = TypeVar("SelfBaseAlgorithm", bound="DecisionAwareBaseAlgorithm")
...
class DecisionAwareBaseAlgorithm(ABC):
    """
    ...
    policy_aliases: ClassVar[dict[str, type[DecisionAwareBasePolicy]]] = {}
    policy: DecisionAwareBasePolicy
    ...
    def __init__(
        self,
        policy: Union[str, type[DecisionAwareBasePolicy]],
    ...
    def _setup_lr_schedule(self) -> None:
        ...
        self.lr_schedule_actor = FloatSchedule(self.learning_rate_actor[0])
        self.lr_schedule_critic = FloatSchedule(self.learning_rate_critic[0])
    ...
    def _get_policy_from_name(self, policy_name: str) -> type[DecisionAwareBasePolicy]:
        """
