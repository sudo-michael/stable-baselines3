...
SelfBaseModel = TypeVar("SelfBaseModel", bound="DecisionAwareBaseModel")


class DecisionAwareBaseModel(nn.Module):
    """
    ...
    optimizer_act: th.optim.Optimizer
    optimizer_critic: th.optim.Optimizer
...
class DecisionAwareBasePolicy(DecisionAwareBaseModel, ABC):
...
class DecisionAwareActorCriticPolicy(DecisionAwareBasePolicy):
    """
    ...
    def get_distribution(self, obs: PyTorchObs) -> Distribution:
        ...
        dist, mean_actions = self._get_action_dist_from_latent(latent_pi)
        return dist
